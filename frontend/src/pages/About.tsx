            ...
            <section className="pt-32 pb-16 bg-gradient-to-b from-gray-50 to-white">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-6">
                        We believe small stores deserve <span className="text-[#005CFF]">big technology</span>
                    </h1>
                    <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                        Fluxor Cloud was born from a simple observation: convenience stores and small shops power our communities,
                        but they're often left behind by technology.
                    </p>
                </div>
            </section>
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="prose prose-lg max-w-none">
                        ...
                        <p className="text-gray-600 mb-6 text-lg leading-relaxed">
                            In 2023, our founders spent time working in convenience stores and small grocery shops to understand
                            the challenges owners face every day. What they found was eye-opening: store owners were making critical
                            decisions based on gut feeling, spending hours on spreadsheets, and struggling to keep up with larger competitors.
                        </p>
                        <p className="text-gray-600 mb-6 text-lg leading-relaxed">
                            They saw a gap. Enterprise retailers had access to sophisticated analytics, demand forecasting, and AI tools.
                            Small stores had none of this — until now.
                        </p>
                        <p className="text-gray-600 text-lg leading-relaxed">
                            Fluxor Cloud brings the power of AI and modern analytics to the people who need it most:
                            the hardworking entrepreneurs who keep our neighborhoods running. We're leveling the playing field,
                            one store at a time.
                        </p>
                    </div>
                </div>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {values.map((value) => (
                            <div key={value.title} className="text-center">
                                <div className="w-16 h-16 bg-blue-50 rounded-2xl flex items-center justify-center text-[#005CFF] mx-auto mb-4">
                                    {value.icon}
                                </div>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {team.map((member) => (
                            <div key={member.name} className="text-center">
                                ...
                                <p className="text-sm text-[#005CFF] mb-2">{member.role}</p>
