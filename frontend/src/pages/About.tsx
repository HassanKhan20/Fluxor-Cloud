    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <div className="relative overflow-hidden">
                {/* Left side gradient - static, no animation */}
                <div className="absolute left-0 top-0 h-full w-48 pointer-events-none bg-gradient-to-r from-blue-950/70 to-transparent z-10" />

                {/* Right side gradient - static, no animation */}
