...
import { ArrowRight, BarChart3, Package, Bot, TrendingUp, FileText, Zap, X, Check, Heart, Target, Users } from 'lucide-react';
...
const Landing: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-white">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative" style={{ zIndex: 2 }}>
                    ...
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
                            ...
                            <Link to="/#features" onClick={(e: React.MouseEvent<HTMLAnchorElement>) => {
            ...
            {/* Features Section */}
            <section id="features" className="py-20 lg:py-32 bg-gray-50 scroll-mt-24">
            ...
            <section id="pricing" className="py-20 lg:py-32 bg-white scroll-mt-24">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        ...
                        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
                            Plans that grow with <span className="text-blue-600">your store</span>
                        </h2>
                        <p className="text-lg text-gray-600" style={{ lineHeight: '1.7' }}>
            ...
            {/* About/Values Section - Merged */}
            <section id="about" className="py-20 lg:py-32 bg-gray-50 scroll-mt-24">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        ...
                        <p className="text-lg text-gray-600" style={{ lineHeight: '1.7' }}>
                            We believe small stores deserve big technology. Here is what drives us.
                        </p>
                    </div>
